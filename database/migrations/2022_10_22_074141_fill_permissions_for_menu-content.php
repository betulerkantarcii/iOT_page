...
class FillPermissionsForMenuContent extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMenuContent constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.menu-content',
            'admin.menu-content.index',
            'admin.menu-content.create',
            'admin.menu-content.show',
            'admin.menu-content.edit',
            'admin.menu-content.delete',
            'admin.menu-content.bulk-delete',
        ]);
