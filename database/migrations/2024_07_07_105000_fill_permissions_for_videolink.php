...
class FillPermissionsForVideolink extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVideolink constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.videolink',
            'admin.videolink.index',
            'admin.videolink.create',
            'admin.videolink.show',
            'admin.videolink.edit',
            'admin.videolink.delete',
            'admin.videolink.bulk-delete',
        ]);
