...
class FillPermissionsForNewsandevent extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNewsandevent constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.newsandevent',
            'admin.newsandevent.index',
            'admin.newsandevent.create',
            'admin.newsandevent.show',
            'admin.newsandevent.edit',
            'admin.newsandevent.delete',
            'admin.newsandevent.bulk-delete',
        ]);
