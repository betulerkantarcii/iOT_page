...
class FillPermissionsForChoiceOfTemplate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChoiceOfTemplate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.choice-of-template',
            'admin.choice-of-template.index',
            'admin.choice-of-template.create',
            'admin.choice-of-template.show',
            'admin.choice-of-template.edit',
            'admin.choice-of-template.delete',
            'admin.choice-of-template.bulk-delete',
        ]);
