...
class FillPermissionsForEventCalendar extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEventCalendar constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.event-calendar.create',
            'admin.event-calendar.show',
            'admin.event-calendar.edit',
            'admin.event-calendar.delete',
            'admin.event-calendar.bulk-delete',
        ]);
