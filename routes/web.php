...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('research')->name('research/')->group(static function() {
            Route::get('/',                                             'ResearchController@index')->name('index');
            Route::get('/create',                                       'ResearchController@create')->name('create');
            Route::post('/',                                            'ResearchController@store')->name('store');
            Route::get('/{research}/edit',                              'ResearchController@edit')->name('edit');
            Route::post('/bulk-destroy',                                'ResearchController@bulkDestroy')->name('bulk-destroy');
            Route::post('/{research}',                                  'ResearchController@update')->name('update');
            Route::delete('/{research}',                                'ResearchController@destroy')->name('destroy');
        });
    });
});
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('sliders')->name('sliders/')->group(static function() {
            ...
            Route::post('/bulk-destroy',                                'SliderController@bulkDestroy')->name('bulk-destroy');
            Route::post('/{slider}',                                    'SliderController@update')->name('update');
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('newsandevents')->name('newsandevents/')->group(static function() {
            Route::get('/',                                             'NewsandeventsController@index')->name('index');
            Route::get('/create',                                       'NewsandeventsController@create')->name('create');
            Route::post('/',                                            'NewsandeventsController@store')->name('store');
            Route::get('/{newsandevent}/edit',                          'NewsandeventsController@edit')->name('edit');
            Route::post('/bulk-destroy',                                'NewsandeventsController@bulkDestroy')->name('bulk-destroy');
            Route::post('/{newsandevent}',                              'NewsandeventsController@update')->name('update');
            Route::delete('/{newsandevent}',                            'NewsandeventsController@destroy')->name('destroy');
        });
    });
});
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('videolinks')->name('videolinks/')->group(static function() {
            Route::get('/',                                             'VideolinkController@index')->name('index');
            Route::get('/create',                                       'VideolinkController@create')->name('create');
            Route::post('/',                                            'VideolinkController@store')->name('store');
            Route::get('/{videolink}/edit',                             'VideolinkController@edit')->name('edit');
            Route::post('/bulk-destroy',                                'VideolinkController@bulkDestroy')->name('bulk-destroy');
            Route::post('/{videolink}',                                 'VideolinkController@update')->name('update');
            Route::delete('/{videolink}',                               'VideolinkController@destroy')->name('destroy');
        });
    });
});